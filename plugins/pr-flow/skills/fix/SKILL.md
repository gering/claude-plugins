...
name: fix
description: |
  Walks the latest Claude review: numbered checklist with severity, user
  picks by number/range/severity, minimal edits.
  Trigger: "fix the review", "address claude's feedback", "work through the issues".
user_invocable: true
---
