...
- `features/herdr-tab-glyphs.md` — Task-state glyphs (`○ ● ◇ ✓`) on herdr tab names: `states` mode inside the self-contained renderer (no sibling), sync PR refresh for triggers, exact-cwd rename rules, soft pr-flow shim
